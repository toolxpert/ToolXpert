  ...
  def info(self):
    ...
    while self.on:
      ...
      if size != 0:
        ...
        print(stage(
            f"{fluo}{round(size)} {green}Mb/s {black}-{white} Total: {fluo}{round(self.total, 1)} {white}Gb. {' '*20}"
        ),
              end='\r')
...
def main():
  print()
  print(
  Colorate.Diagonal(Col.DynamicMIX((Col.white, Col.blue)), Center.XCenter(banner)))
